...
public class DataSeeder implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        createOrUpdateResource(
                ...
                (lang) -> {
                    try {
                        // Eğer özel dosya (tefriciye_en.txt vb.) varsa onu yükle, yoksa TR yükle
